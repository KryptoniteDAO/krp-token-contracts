use crate::helper::{BASE_RATE_14, BASE_RATE_6, BASE_RATE_8};
use crate::msg::{
...
use cosmwasm_std::{Addr, Deps, Env, StdResult, Uint128, Uint256};
use std::str::FromStr;
...
pub fn get_boost(_deps: Deps, _account: Addr) -> StdResult<GetBoostResponse> {
    Ok(GetBoostResponse {
        boost: Uint128::from(BASE_RATE_8),
    })
}
