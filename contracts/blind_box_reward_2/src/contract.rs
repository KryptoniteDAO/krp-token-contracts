...
pub fn instantiate(
    ...
    for reward_token_map_msg in msg.reward_token_map_msgs {
        let mut reward_level_configs = Vec::with_capacity(reward_token_map_msg.reward_levels.len());
        for reward_level_config_msg in reward_token_map_msg.reward_levels {
            let reward_level_config = RewardLevelConfig {
                reward_level_index: reward_level_config_msg.level_index,
                reward_amount: reward_level_config_msg.reward_amount.unwrap_or(0),
                is_random_box: reward_level_config_msg.is_random_box,
            };
            reward_level_configs[reward_level_config_msg.level_index] = reward_level_config;
        }
