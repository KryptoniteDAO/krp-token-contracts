...
pub fn get_reward(
    ...
    let unlock_time_msg = boost::msg::QueryMsg::GetUnlockTime {
        user: sender.clone(),
    };
    let unlock_time_response: boost::msg::GetUnlockTimeResponse =
        deps.querier.query(&QueryRequest::Wasm(WasmQuery::Smart {
            contract_addr: staking_config.boost.clone().to_string(),
